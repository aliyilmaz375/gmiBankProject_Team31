Feature: US_01 Register
  ...
  Scenario: TC_001 register pozitif test
    ...
    And kullanici SSN textboxina "345-45-4371" numarasini girer
    ...
    And kullanici Username textboxina  "werty84" kullanici adini girer
    And kullanici Email textboxina "wert84@gmail.com" mail adresini girer
    ...
    And Kullanici SSN search textboxina "345-45-4371" numarasini girer
    ...
    And kullanici sag ustteki simgeye tiklar
    And kullanici Sign In tiklar
    And kullanici username olarak "werty63" girer
